 window.onload = function() {
    ...
    var options = {
        center: new daum.maps.LatLng(37.325989,126.951622),
        level: 2
    };
    ...
    var markerPosition  = new daum.maps.LatLng(37.325989,126.951622); 
    ...
    var options2 = {
        center: new daum.maps.LatLng(35.228762,128.645886),
        level: 2
    };
    ...
    var markerPosition2  = new daum.maps.LatLng(35.228762,128.645886); 
   ...
   var options3 = {
       center: new daum.maps.LatLng(36.986707,126.731663),
       level: 2
   };
   ...
   var markerPosition3  = new daum.maps.LatLng(36.986707,126.731663); 
