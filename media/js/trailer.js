    ...
    $.ajax({
        ...
        success: function(data){
            ...
            $('.song_lst li a').click(function(e){
                ...
                $('.trans_song .youtube iframe').attr('src', trailerSongs[ind].url);
                $('.trans_song .youtube_wrap dt').html(trailerSongs[ind].title);
                $('.trans_song .youtube_wrap dd:eq(0)').html(trailerSongs[ind].channel);
                $('.trans_song .youtube_wrap dd:eq(1)').html(trailerSongs[ind].tag);
